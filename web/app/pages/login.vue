    ...
    <div class="bg-white rounded-2xl p-8 shadow-sm max-w-sm w-full text-center">
      ...
      <template v-else>
        <button
          ...
          class="w-full flex items-center justify-center gap-3 px-6 py-3 border border-gray-300 rounded-xl hover:bg-gray-50 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
